    ...
    dispatch_once(&onceToken, ^{
        testingPublicKeys = @[
            [[MTDatacenterAuthPublicKey alloc] initWithPublicKey:@"-----BEGIN RSA PUBLIC KEY-----\n"
             "MIIBCgKCAQEAuFqmAgs4V2RPTmolB9KJ+vcItKd0Ou6HV9NXJyw+1TgUu3D/MUTr\n"
             "VJbU2u7xDrgeUL3VoeS4W4wLH/H+9YPUNeOg+d4nk79UfF8tSSTD3wVjTU9082u4\n"
             "q9sQ9zXs+j+CyNQ12LxST9820gOK2b4tAymm9Pzlxw4YRU2P8BUJsvmnPneg4V9x\n"
             "dyfmL71jbgBORq1YeRp4ANnHeq5oxxkhyHvPgaItmbVKKcnAgkEf4b79Dhtvy6Rz\n"
             "bNI0QKYKwqbJPHmHad71Bs8A3hK1xb7r3a2DuVKaS3LlDO4gczfUgcb8Rm/4UbxW\n"
             "UNRZGv4K4SigPYuGB85Eha2MODnvM+u9pQIDAQAB\n"
             "-----END RSA PUBLIC KEY-----"]
        ];
